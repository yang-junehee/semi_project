			...
			<div class="row">
				...
				<div class="col-12 col-sm-6 col-lg-4">
					<div class="about-us-thumbnail mb-50">
						<span class="line"></span> <img src="./img/bg-img/monet.PNG"
				...
				<div class="col-12 col-lg-4">
					<div class="about-us-content mb-50">
						...
						<p>1840.11.14 ~ 1926.12.5</p>
						<p>프랑스 파리</p>
						<p>프랑스의 인상파 화가. 인상파 양식의 창시자 중 한 사람으로, 그의 작품 《인상, 일출》에서
							‘인상주의’라는 말이 생겨났다. ‘빛은 곧 색채’라는 인상주의 원칙을 끝까지 고수했으며, 연작을 통해 동일한 사물이
							빛에 따라 어떻게 변하는지 탐색했다. 말년의 《수련》 연작은 자연에 대한 우주적인 시선을 보여준 위대한 걸작으로
							평가받는다.</p>
					</div>
				</div>
			</div>
