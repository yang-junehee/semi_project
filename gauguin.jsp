			...
			<div class="row">
				...
				<div class="col-12 col-sm-6 col-lg-4">
					<div class="about-us-thumbnail mb-50">
						<span class="line"></span> <img src="./img/bg-img/gauguin.PNG" alt="">
				...
				<div class="col-12 col-lg-4">
					<div class="about-us-content mb-50">
						...
						<p>1848.6.7 ~ 1903.5.8</p>
						<p>프랑스 파리</p>
						<p>프랑스 후기인상파 화가. 문명세계에 대한 혐오감으로 남태평양의 타히티섬으로 떠났고 원주민의 건강한 인간성과
							열대의 밝고 강렬한 색채가 그의 예술을 완성시켰다. 그의 상징성과 내면성, 그리고 비(非)자연주의적 경향은 20세기
							회화가 출현하는 데 근원적인 역할을 했다.</p>
					</div>
				</div>
			</div>
		</div>
								...
								<p>
									<button type="button" class="btn btn-secondary"
										...
										<img class="artimg" alt="123"
											src="./img/bg-img/gauguin/${art.file }">
									</button>
								</p>
							</div>
						</div>
