...
@WebServlet("/degasList")
public class degasListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public degasListController() {
        super();
    }
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(art != null) {
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("degas.jsp");
