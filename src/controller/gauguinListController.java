...
@WebServlet("/gauguinList")
public class gauguinListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public gauguinListController() {
        super();
    }
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(art != null) {
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("gauguin.jsp");
