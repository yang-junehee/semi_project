...
@WebServlet("/milletList")
public class milletListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public milletListController() {
        super();
    }
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(art != null) {
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("millet.jsp");
